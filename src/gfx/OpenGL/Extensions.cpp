...
static const char* functionNames = {
...
#else // !GFX_ENABLE_COMPUTE_SHADERS
	UNUSED_GL_EXTENSION
...
#else // !GFX_ENABLE_UNIFORM_BUFFER_OBJECT
	UNUSED_GL_EXTENSION
	UNUSED_GL_EXTENSION
	...
	"glGetProgramResourceIndex\x0"
	"glShaderStorageBlockBinding\x0"
	"glMemoryBarrier\x0"
	"glMapBufferRange\x0"
	"glUnmapBuffer\x0"
#else // !GFX_ENABLE_STORAGE_BUFFER_OBJECT
	UNUSED_GL_EXTENSION
	UNUSED_GL_EXTENSION
	UNUSED_GL_EXTENSION
	UNUSED_GL_EXTENSION
